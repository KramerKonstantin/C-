...
StringBuilder StringBuilder::substring(size_t start, size_t end) const {
...
StringBuilder StringBuilder::substring(size_t start) const {
    return substring(start, mSize);
}
